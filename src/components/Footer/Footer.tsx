    ...
    <footer className="footer">
      <div className="container footer-content">
        ...
        <div className="footer-links">
          <a href="https://www.instagram.com/amanda_floralstudio/" target="_blank" rel="noopener noreferrer" className="footer-icon-link">
            <img src="/instagram.svg" alt="Instagram" className="footer-social-icon" />
            <span>Instagram</span>
          </a>
          <a href="https://wa.me/522216872221" target="_blank" rel="noopener noreferrer" className="footer-icon-link">
        ...
        <p className="copyright">
          © {new Date().getFullYear()} amanda. Todos los derechos reservados.
        </p>
      </div>
    </footer>
  );
